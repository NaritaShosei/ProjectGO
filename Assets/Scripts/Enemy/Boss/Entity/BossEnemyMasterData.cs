...
namespace BossEnemy.Character
{
    ...
    {
        public Status[] BossEnemyDatas => _bossEnemyDatas;
        ...
        private Status[] _bossEnemyDatas;
        ...
        public void DataConstruct(Status[] bossEnemyDatas, string bossName)
        {
        ...
        private void EnsureFoldoutCapacity(int requiredSize)
        {
            if (_phasesFoldout == null || _phasesFoldout.Length < requiredSize)
            {
                ...
                if (_phasesFoldout != null)
                    Array.Copy(_phasesFoldout, newArr, _phasesFoldout.Length);
