...
namespace BossEnemy.BehaviorTree
{
    ...
    public class BasedOnRemainingBossHPNode : DecoratorNode, IDisposable
    {
        ...
        public BasedOnRemainingBossHPNode(Status bossEnemyData, ITreeNode child, int entryHPLine, bool isEntryAboveHP) : base (child) 
        {
            // 現在のBossのHPを取得し続ける
    ...
    public class BreakArmorNode : DecoratorNode
    {
        ...
        public void BreakArmor(ArmorAttachmentType armorAttachmentPoint)
        {
        ...
        public override NodeCondition TryEntry()
        {
            if(_armorBreakingPoint == ArmorAttachmentType.LeftLeg || _armorBreakingPoint == ArmorAttachmentType.RightLeg)
            {
                Debug.Log("Down");
                _armorBreakingPoint = ArmorAttachmentType.None;
                return NodeCondition.Success;
            }
        ...
        private ArmorAttachmentType _armorBreakingPoint = ArmorAttachmentType.None;
    }
    #endregion
    ...
    public class CloseToPlayerNode : DecoratorNode
    {
        public CloseToPlayerNode(ITreeNode child, IPlayerInformationService playerInformationService,
            Status bossEnemyData, float nodeEntryLine) : base(child)
        {
